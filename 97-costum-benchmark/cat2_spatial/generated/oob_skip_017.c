 ...
 * PURPOSE: OOB from 512-byte obj at offset 256 → adjacent 512B object
 *
...
int main(void) {
    ...
    if (raw_dist > 0 && raw_dist < 100000) {
        volatile char c = a[raw_dist + 256];
        printf("a[%ld]=%02x\n", (long)(raw_dist + 256), (unsigned char)c);
    } else {
